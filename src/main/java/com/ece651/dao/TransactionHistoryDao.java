 ...
 */
public interface TransactionHistoryDao extends BaseDao<Transaction_history, Integer>{

	public Serializable insertNewTranHistory(Transaction_history transactionHistory);
	...
	public Transaction_history findbyConditions(Transaction_history transactionHistory);

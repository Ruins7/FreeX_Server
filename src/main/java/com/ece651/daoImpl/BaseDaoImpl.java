...
import com.ece651.dao.RowMapper;
import com.ece651.entity.PageResults;

/**
 * @ClassName: BaseDaoImpl.java
 * @Description: Hibernate4 所有常用的数据持久化方法实现
 * 
 * @author Ruins7
 * @version V1.0
...
public class BaseDaoImpl<T, ID extends Serializable> implements
	...
	public T load(Serializable id) {
		T t = (T) sessionFactory.getCurrentSession().load(getEntityClass(), id);
		return t;
	}

	@Override
	public T get(Serializable id) {
		T t = (T) sessionFactory.getCurrentSession().get(getEntityClass(), id);
		return t;
	}
